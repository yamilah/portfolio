    ...
    return (
      <section className="detail-two-implementation">
        ...
        <div className="detail-two-implementation-prototype">
          <video
            autoPlay
            className="detail-two-implementation-prototype-video-1 dropshadow"
            loop
            muted
            poster={vidOnePoster}
          >
          ...
          <video
            autoPlay
            className="detail-two-implementation-prototype-video-2 dropshadow"
            loop
            muted
            poster={vidTwoPoster}
          >
          ...
          <p className="detail-two-implementation-prototype-text-1">
          ...
          <p className="detail-two-implementation-prototype-text-2">
        ...
        <div className="detail-two-implementation-devices">
          <img
            alt="A small Chromebook"
            className="detail-two-implementation-device-1 dropshadow"
            src={imgOne}
          />
          <img
            alt="A luxury Chromebook"
            className="detail-two-implementation-device-2 dropshadow"
            src={imgTwo}
          />
          <p className="detail-two-implementation-device-text">
        ...
        <div className="detail-two-implementation-focus">
          <img
            alt="An error page showing that this app can only be used on Chrome"
            className="detail-two-implementation-focus-img dropshadow"
            src={imgThree}
          />
          <p className="detail-two-implementation-focus-text-1">
          ...
          <p className="detail-two-implementation-focus-text-2">
            I could leverage cutting edge browser standards, such as CSS Grid, which wasn’t available on Internet Explorer.
          </p>
          <p className="detail-two-implementation-focus-text-3">
            This was much to the CTO’s chagrin, who felt very strongly that JavaScript should do the heavy lifting.
          </p>
        </div>
        <div className="detail-two-implementation-snippet">
          <img
            alt="A verbose code snippet"
            className="detail-two-implementation-snippet-img dropshadow"
            src={imgFour}
          />
          <p className="detail-two-implementation-snippet-text-1">
          ...
          <p className="detail-two-implementation-snippet-text-2">
          ...
          <p className="detail-two-implementation-snippet-text-3">
