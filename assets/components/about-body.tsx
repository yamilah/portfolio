      ...
      <section className="about-body">
        <div className="about-body-top">
          <p className="about-body-top-text-1">
            Yamilah Atallah <span className="about-body-top-text-emphasis">(jah•MEE•lah ah•tah•LAH)</span> is a designer and front-end developer based in Redwood City, CA, currently working at Disney+. She studied graphic design at Massachusetts College of Art and Design, graduating summa cum laude in 2015. Previously, she worked with <a href="https://thoughtbot.com">thoughtbot</a>, an SF-based design consultancy. Her clients have included Houseparty, True Botanicals, Bulletproof Coffee, and The County of San Mateo.
          </p>
        ...
        <div className="about-body-bottom">
          ...
          <p className="about-body-bottom-text-2">
            Prior to joining thoughtbot, she worked at LevelUp Agency, partnering with clients like Zaxby’s, Pret-A-Manger, Clean Juice, Cowboy Chicken, and Noon Mediterranean to create apps connecting eaters and restaurants.
          </p>
