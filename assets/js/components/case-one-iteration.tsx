  ...
  render() {
    return (
      <section className="case-one-iteration">
        <div className="case-one-iteration-separator">
          <p className="case-one-iteration-separator-number">
            02
          </p>
          <p className="case-one-iteration-separator-text">
            Iterations & testing
          </p>
        </div>
        <div className="case-one-iteration-prototype">
          <video
            autoPlay
            className="case-one-iteration-prototype-video dropshadow"
            loop
            muted
            poster={vidOnePoster}
          >
          ...
          <p className="case-one-iteration-prototype-text">
        ...
        <div className="case-one-iteration-figures">
          <figure className="case-one-iteration-figure-1">
            <p className="case-one-iteration-figure-number">
              3/5
            </p>
            <p className="case-one-iteration-figure-text">
              participants could not figure out where notifications were
            </p>
          </figure>
          <figure className="case-one-iteration-figure-2">
            <p className="case-one-iteration-figure-number">
              5/5
            </p>
            <p className="case-one-iteration-figure-text">
          ...
          <figure className="case-one-iteration-figure-3">
            <p className="case-one-iteration-figure-number">
              4/5
            </p>
            <p className="case-one-iteration-figure-text">
          ...
          <figure className="case-one-iteration-figure-4">
            <p className="case-one-iteration-figure-number">
              5/5
            </p>
            <p className="case-one-iteration-figure-text">
        ...
        <div className="case-one-iteration-progress">
          <video
            autoPlay
            className="case-one-iteration-progress-video dropshadow"
            loop
            muted
            poster={vidTwoPoster}
          >
          ...
          <p className="case-one-iteration-progress-text-1">
          ...
          <p className="case-one-iteration-progress-text-2">
        ...
        <div className="case-one-iteration-ideas">
          <img
            alt="A product concept drawing"
            className="case-one-iteration-idea-1 dropshadow"
            src={imgFive}
          />
          <img
            alt="A product concept drawing"
            className="case-one-iteration-idea-2 dropshadow"
            src={imgFour}
          />
          <img
            alt="A product concept drawing"
            className="case-one-iteration-idea-3 dropshadow"
            src={imgThree}
          />
          <img
            alt="A product concept drawing"
            className="case-one-iteration-idea-4 dropshadow"
            src={imgTwo}
          />
          <img
            alt="A product concept drawing"
            className="case-one-iteration-idea-5 dropshadow"
            src={imgOne}
          />
          <p className="case-one-iteration-idea-text">
