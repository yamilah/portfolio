...
export default class CaseTwoDescription extends React.Component {
  render() {
    return (
      <section className="case-two-intro">
        <div className="case-two-highlights">
          <div className="case-two-highlight">
            <h1 className="case-two-highlight-heading">
              Opportunity
            </h1>
            <p className="case-two-highlight-text">
        ...
        <div className="case-two-text-wrapper">
          <p className="case-two-text">
