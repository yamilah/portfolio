  ...
  render() {
    return (
      <section className="case-two-planning">
        <div className="case-two-planning-separator">
          <p className="case-two-planning-separator-number">
            01
          </p>
          <p className="case-two-planning-separator-text">
            Initial validation & planning
          </p>
        </div>
        <div className="case-two-planning-context">
          <video
            autoPlay
            className="case-two-planning-context-video dropshadow"
            loop
            muted
            poster={vidOnePoster}
          >
          ...
          <p className="case-two-planning-context-text-1">
            So, to start things off, I'd like to provide a little context into how the product works:
          </p>
          <p className="case-two-planning-context-text-2">
          ...
          <p className="case-two-planning-context-text-3">
            But it didn’t start with this idea.
          </p>
        </div>
        <div className="case-two-planning-request">
          <img
            alt="An image showing a few screen excerpts from HQ, a trivia app"
            className="case-two-planning-request-img dropshadow"
            src={imgOne}
          />
          <p className="case-two-planning-request-text-1">
          ...
          <p className="case-two-planning-request-text-2">
            Users could win real money by answering all the questions and not being eliminated in multiple daily games.
          </p>
          <p className="case-two-planning-request-text-3">
            So that was the problem they were wanting us to solve, that was the ask. To build that. For sports.
          </p>
        </div>
        <div className="case-two-planning-sprints">
          <div className="case-two-planning-sprint-top">
            <p className="case-two-planning-sprint-top-text-1">
            ...
            <p className="case-two-planning-sprint-top-text-2">
          ...
          <div className="case-two-planning-sprint-bottom">
            ...
            <p className="case-two-planning-sprint-bottom-text-2">
            ...
            <p className="case-two-planning-sprint-bottom-text-3">
            ...
            <img
              ...
              className="case-two-planning-sprint-bottom-img-2 dropshadow"
              src={imgThree}
            />
          </div>
        </div>
